...
pub fn interpolate_color(from: Color, to: Color, t: f64) -> Color {
    ...
    let r =
        (from_rgba.r as f32 + (to_rgba.r as f32 - from_rgba.r as f32) * t).clamp(0.0, 255.0) as u8;
    let g =
        (from_rgba.g as f32 + (to_rgba.g as f32 - from_rgba.g as f32) * t).clamp(0.0, 255.0) as u8;
    let b =
        (from_rgba.b as f32 + (to_rgba.b as f32 - from_rgba.b as f32) * t).clamp(0.0, 255.0) as u8;
    let a =
        (from_rgba.a as f32 + (to_rgba.a as f32 - from_rgba.a as f32) * t).clamp(0.0, 255.0) as u8;
...
pub fn interpolate_rgba8(from: (u8, u8, u8, u8), to: (u8, u8, u8, u8), t: f64) -> (u8, u8, u8, u8) {
    let t = t.clamp(0.0, 1.0) as f32;
