...
pub use chart::{
    ...
    DEFAULT_POINT_RADIUS, DatumKey, DatumMatch, Encoding, GuideSpec, MarkBatch, MarkKind, MarkSpec,
    MarkTransition, MatchPolicy, POINT_RADIUS_RANGE, ScaleKind, ScaleSpec, TransitionFallback,
    TransitionKind,
};
