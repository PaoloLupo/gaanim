...
pub fn get_anchor_point(bounds: Bounds3D, transform: &SpatialTransform, anchor: Anchor) -> DVec3 {
...
pub fn get_corner(bounds: Bounds3D, transform: &SpatialTransform, corner: Anchor) -> DVec3 {
    get_anchor_point(bounds, transform, corner)
}

/// Returns the world-space position of an edge center.
pub fn get_edge_center(bounds: Bounds3D, transform: &SpatialTransform, edge: Direction) -> DVec3 {
