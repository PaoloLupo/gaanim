...
class Expr:
    """Native scalar expression that can reference animated parameters."""
    def __init__(self, value: float) -> None: ...
    @staticmethod
    def var(name: str) -> Expr: ...
    @staticmethod
    def constant(value: float) -> Expr: ...
    def derivative(self, variable: str) -> Expr: ...
    def sin(self) -> Expr: ...
    def cos(self) -> Expr: ...
    def tan(self) -> Expr: ...
    def exp(self) -> Expr: ...
    ...
    def min(self, other: Expr | float) -> Expr: ...
    def max(self, other: Expr | float) -> Expr: ...
    def clamp(self, minimum: Expr | float, maximum: Expr | float) -> Expr: ...
    def if_positive(self, when_true: Expr | float, when_false: Expr | float) -> Expr: ...
    def eval(self, **variables: float) -> float: ...
    ...
    def __pow__(self, other: Expr | float, modulo: object = None) -> Expr: ...
...
class CoordinateSpace:
    ...
    def plot(
        self,
        function: Expr | Callable[[float], float],
