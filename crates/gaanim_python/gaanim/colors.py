"""Tailwind CSS v4.3.3 color palette (official theme.css values)."""
...
class _TailwindPalette:
    ...
    def __init__(self):
        for family, shades in _VALUES.items():
            setattr(self, family, {shade: Color(value) for shade, value in shades.items()})
