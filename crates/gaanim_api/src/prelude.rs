...
pub use crate::canvas::{
    ...
    Canvas, CanvasEndpoint, CanvasRay, CanvasTheme, CanvasUnits, ChartHandle, DimensionHandle,
    DimensionOptions, Direction, DrawableHandle, ForceVectorHandle, ObjectSpec, Parameter,
    PointRef, SegmentError, SegmentHandle, SegmentId, SegmentManifest, SegmentSpec, SegmentStop,
    SpawnKind, SupportHandle, ThemePalette,
};
