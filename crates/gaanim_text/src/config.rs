...
impl Default for TextConfig {
    fn default() -> Self {
        ...
        roles.insert(TextRole::Title, RoleStyle {
        ...
        roles.insert(TextRole::Subtitle, RoleStyle {
            font_family: "Arial".to_string(),
            size: 48.0,
            fill_color: gaanim_core::peniko::Color::WHITE,
        });
        ...
        roles.insert(TextRole::Body, RoleStyle {
            font_family: "Arial".to_string(),
            size: 32.0,
            fill_color: gaanim_core::peniko::Color::WHITE,
        });
        ...
        roles.insert(TextRole::Caption, RoleStyle {
            font_family: "Arial".to_string(),
            size: 24.0,
            fill_color: gaanim_core::peniko::Color::WHITE,
        });
        ...
        // Monospace code role
        roles.insert(TextRole::Code, RoleStyle {
