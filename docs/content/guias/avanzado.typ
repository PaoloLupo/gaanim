...
estables. Consulta #link("/referencia/visualization/")[Visualización] para elegir entre
...
- #link("/guias/proyectos/")[Proyectos] explica manifiesto, recursos y salidas.
- #link("/guias/presentaciones/")[Presentaciones] cubre segmentos, notas y paradas.
- #link("/guias/capturas-y-comparacion/")[Regresión visual] enseña capturas,
  comparación y aprobación de cambios.
- #link("/referencia/")[Referencia de la API] contiene firmas y contratos técnicos.
