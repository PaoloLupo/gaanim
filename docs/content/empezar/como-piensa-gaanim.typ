...
#link("/referencia/")[referencia de la API].

Si prefieres aprender por piezas pequeñas, consulta los
#link("/ejemplos/basicos/")[ejemplos básicos]. Si ya conoces el flujo principal,
salta a #link("/guias/avanzado/")[temas avanzados].

== Siguiente paso

Continúa con #link("/empezar/instalacion/")[Instalación y primeros pasos].
