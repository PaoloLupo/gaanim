...
Cada fábrica devuelve un objeto fluido. `fill`, `stroke`, `no_fill` y `move_to`
...
#link("/empezar/como-piensa-gaanim/")[Partes de una escena] veremos qué responsabilidad tiene
