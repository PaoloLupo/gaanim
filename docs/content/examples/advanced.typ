...
#show: docs-chapter.with(
  ...
  description: "Complex gaanim animations with selections, groups, and themes",
...
More complex animations demonstrating glyph selection, grouping, themes, and reactive features.

== Equation with Glyph Selection

Select and animate individual parts of a mathematical equation.

```python
# output: equation_select.webp
# show-code: true
# caption: Equation with glyph-level selection and animation
...
Dynamic theme switching during an animation.

```python
# output: theme_switch.webp
# show-code: true
# caption: Dynamic theme switching between Dracula and Gruvbox
...
Working with groups of mobjects.

```python
# output: group_demo.webp
# show-code: true
# caption: Grouping, positioning, and animating groups
...
== Path Following with Traced Path

A dot following a circular path with a trailing effect.

```python
# output: path_trace.webp
# show-code: true
# caption: Orbital motion with traced path trail
