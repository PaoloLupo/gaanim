...
4. Mirror the runtime signature and return type in `gaanim_core.pyi`.
...
Keep compatibility aliases intentional and documented. Do not silently accept
or ignore arguments merely to resemble Manim unless that compatibility is part
