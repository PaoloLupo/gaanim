...
energy = scene.text.equation(
    ...
    part("mass", "m"),
    part("light", "c^2"),
).fill(WHITE).move_to(0, 1.555556)
momentum = scene.text.equation(
    "p =",
    part("mass", "m"),
    part("velocity", "v"),
).fill(WHITE).move_to(0, -1.777778)

frame = scene.geometry.surrounding_rect(energy["mass"]).stroke(GOLD, 0.088889)
...
scene.play([momentum.animate.shift_by(2.444444, 0).duration(0.8)])
scene.wait(0.3)
