...
normal = scene.geometry.normal_on_curve(curve, tracker, length=1.725).stroke(GOLD, 0.09375)
title = scene.text("normal on curve").fill(BLACK).move_to(0, 3.5625, anchor=Anchor.CENTER)
