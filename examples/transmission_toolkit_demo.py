...
driver = scene.mechanics.gear(86, 24, bore_radius=12, color=GOLD).at(-300, 40)
driven = scene.mechanics.gear(50, 14, bore_radius=9, color=BLUE).at(-140, 40)
driven.bind_rotation_from(driver, ratio=-24 / 14)
rack = scene.mechanics.rack(360, 24, color=WHITE).at(-210, -125)
...
cam = scene.mechanics.cam_profile(samples, bore_radius=10, color=GREEN).at(300, 35)
