...
c.play([circle.animate.write(2.0).linear()])
...
c.play([create_label.animate.write(0.8).linear()])
c.play([create_title.animate.create(2.8).linear()])
...
c.play([write_label.animate.write(0.8).linear()])
c.play([write_formula.animate.write(3.0).lag_ratio(0.12)])
...
c.play([dbtf_label.animate.write(0.8).linear()])
