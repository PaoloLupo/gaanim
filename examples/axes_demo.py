...
from gaanim import BLACK, BLUE, GOLD, GRAY, GREEN, RED, TEAL, WHITE, Scene
...
label = scene.text("(2, 1)").fill(RED).scaled(0.45).at(*axes2.coords_to_point(2, 1)).next_to(dot, (0, 1), spacing=8)
...
axes4 = scene.axes(
    ...
    ticks=True,
    numbers=True,
    axis_config=None,  # manim compat dict (no-op, aceptado)
    x_axis_config=None,
    y_axis_config=None,
    tips=True,
    auto_fit=True,
