...
c1 = scene.geometry.circle(55.0).fill(BLUE).stroke(WHITE, 3.0).at(-420, 120)
s1 = scene.geometry.square(90.0).fill(RED).stroke(WHITE, 3.0).at(-260, 120)
s2 = scene.geometry.square(90.0).fill(GOLD).stroke(WHITE, 3.0).at(-100, 120)
tri = scene.geometry.regular_polygon(3, 60).fill(GREEN).stroke(WHITE, 3.0).at(-260, -40)
...
c2 = scene.geometry.circle(55.0).fill(GOLD).stroke(WHITE, 3.0).at(260, 120)
s3 = scene.geometry.square(90.0).fill(BLUE).stroke(WHITE, 3.0).at(420, 120)
star = scene.geometry.star(5, 60, 30).fill(RED).stroke(WHITE, 3.0).at(420, -40)
tri2 = scene.geometry.regular_polygon(3, 60).fill(RED).stroke(WHITE, 3.0).at(100, 120)
rect = scene.geometry.rect(110, 70).fill(WHITE).stroke(WHITE, 3.0).at(260, -40)
...
e1 = scene.text.equation("E = m c").fill(WHITE).at(0, 80).scaled(1.3)
e1.write().duration(0.7).smooth()
scene.wait(0.3)

e2 = scene.text.equation("p = m v^2").fill(GOLD).at(0, 80).scaled(1.3)
