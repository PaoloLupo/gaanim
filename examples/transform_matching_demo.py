...
s1 = scene.geometry.square(90.0).fill(RED).stroke(WHITE, 3.0).move_to(-260, 120)
...
c2 = scene.geometry.circle(55.0).fill(GOLD).stroke(WHITE, 3.0).move_to(260, 120)
s3 = scene.geometry.square(90.0).fill(BLUE).stroke(WHITE, 3.0).move_to(420, 120)
star = scene.geometry.star(5, 60, 30).fill(RED).stroke(WHITE, 3.0).move_to(420, -40)
tri2 = scene.geometry.regular_polygon(3, 60).fill(RED).stroke(WHITE, 3.0).move_to(100, 120)
rect = scene.geometry.rect(110, 70).fill(WHITE).stroke(WHITE, 3.0).move_to(260, -40)
